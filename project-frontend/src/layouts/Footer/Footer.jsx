          ...
          >
            <Grid item xs={12} sm={4.5} md={4.5} lg={5}>
              <div className={`${classes.footerImg}`}>
                <img alt="Logo" src={footerlogo} className="w-[108px]" />
              </div>
              <div className={`${classes.footerDivide}`}>
                ...
                <p className={`${classes.footerText}`}>
                  Sec 11, Suman Tower, Suman Tyres
                  Near Sec 11 Petrol Pump Gandhinagar, Gujarat 382011
                </p>
                ...
                <p className={`${classes.emailText} contactWrapper`}>
                  ...
                  <Link to="tel:+919426636250">+91 9426636250</Link>
                </p>
